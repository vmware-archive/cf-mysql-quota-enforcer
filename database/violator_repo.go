...
func NewViolatorRepo(brokerDBName, adminUser, readOnlyUser string, db *sql.DB, logger lager.Logger) Repo {
	query := fmt.Sprintf(violatorsQueryPattern, adminUser, readOnlyUser, brokerDBName)
